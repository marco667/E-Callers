  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      <li class="sidebar-brand">
        <a class="js-scroll-trigger" href="index.jsp">ECall</a>
      </li>
        	...
        	<form class= "form-horizontal" role="form" method="post" action="Inscription">
        		...
        		<div class = "form-group">
        			<div class="col-lg-6 mx-auto">
        				<input type="name" class="form-control" name="username" id="name" value="<c:out value="${utilisateur.username}"/>" placeholder="Entrer votre nom *" />
        				<span class="erreur">${form.erreurs['username']}</span>
        			</div>
        		</div>
        		<div class = "form-group">
        			<div class="col-lg-6 mx-auto">
        				<input type="name" class="form-control" name="surname" id="name" value="<c:out value="${utilisateur.surname}"/>" placeholder="Entrer votre prenom"/>
        				<span class="erreur">${form.erreurs['surname']}</span>
        			</div>
        		</div>
        		<div class = "form-group">
        			<div class="col-lg-6 mx-auto">
        				<input type="tel" class="form-control" name="num_tel" id="tel" value="<c:out value="${utilisateur.num_tel}"/>" placeholder="Entrer votre numero *"/>
	        	...
	        	<c:if test="${!empty erreur}"><p style="color:green;"><c:out value="${erreur}"/></p></c:if>
        	</form>
        </div>
      </div>
    </div>
