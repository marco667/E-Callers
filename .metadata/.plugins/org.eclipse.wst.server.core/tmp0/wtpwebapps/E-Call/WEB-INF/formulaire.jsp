...
<body id="page-top">
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      <li class="sidebar-brand">
        ...
        ${sessionScope.sessionUtilisateur.username} 
         ${sessionScope.sessionUtilisateur.num_tel}
      </a>
      </li>
  ...
  <header class="masthead d-flex">
    ...
    <%-- Vérification de la présence d'un objet utilisateur en session --%>
      ...
      <h4 class="mb-4">
        <em> Informations Supplementaires </em>
      </h4>
      <div class = "form-group">
        		
      		<form class= "form-horizontal" role="form" method="post" action="InfosSupplements" enctype="multipart/form-data" >
      		 <fieldset>
	               <div class = "form-group">
	        			<div class="col-lg-3 mx-auto">
	        				<input type="file" class="form-control" name="photoUser" id="file" placeholder="Ajouter une photo">
	        				<span class="erreur">${form.erreurs['photoUser']}</span>
	        			</div>
	        		</div>
	        		<div class = "form-group">
	        			<div class="col-lg-6 mx-auto">
	        				<input type="date" class="form-control" name="dateNaiss" id="date" placeholder="Entrer votre date de naissance">
	        				<span class="erreur">${form.erreurs['dateNaiss']}</span>
	        			</div>
	        		</div>
	        		<div class = "form-group">
	        			<div class="col-lg-6 mx-auto">
	        		...
	        		<div class = "form-group">
	        			<div class="col-lg-10 mx-auto">
	        				...
	        				<select class="col-lg-3 mx-auto" name="sexe" id="sexe" >
	        					<option>Homme</option>
	        					<option>Femme</option>
	        				</select>
	        		...
	        		<button type="submit" class="btn btn-primary">Validez vos informations</button>
	        		<p class="${empty form.erreurs ? 'succes' : 'erreur'}" style="color:red;">${form.resultat}</p>
	        		<c:if test="${!empty form.erreurs}"><p style="color:green;"><c:out value="${form.resultat}"/></p></c:if>
        	</fieldset>
          </form>
